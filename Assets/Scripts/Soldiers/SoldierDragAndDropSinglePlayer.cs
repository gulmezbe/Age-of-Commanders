...
public class SoldierDragAndDropSinglePlayer : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    [SerializeField]
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        {
            PlayerObjectToSpawnSoldier.GetComponent<PlayerSoldierSpawnSinglePlayer>().SoldierSpawn(droppedLane, eventData.pointerDrag.tag);
            spawnTimer = 0.0f;
        }
